...
public class NotationQueueTest {
	...
	public void testDequeueStudent() {
		...
		assertEquals((Double) 14.3, doubleQ.dequeue());
		assertEquals((Double) 46.4, doubleQ.dequeue());
		assertEquals((Double) 49.3, doubleQ.dequeue());
	...
	public void testToStringStudent()throws QueueOverflowException{
		//Use the doubleQ for student tests
		assertEquals("14.346.449.3", doubleQ.toString());
		doubleQ.enqueue(num4);
		assertEquals("14.346.449.354.3", doubleQ.toString());
		doubleQ.enqueue(num5);
		assertEquals("14.346.449.354.323.3", doubleQ.toString());
